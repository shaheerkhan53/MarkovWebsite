...
export default function FinanceIndustryPage() {
  ...
  return (
    <div className="bg-white">
      {/* Hero Section */}
      <section className="relative py-20 bg-gradient-to-r from-[#0D9488] to-[#0F766E] text-white overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            <motion.div variants={fadeInUp}>
              <span className="inline-block px-3 py-1 mb-6 text-xs font-semibold rounded-full bg-[#0D9488] text-white">
                HealthCare Industry
              </span>
              ...
              <p className="text-lg text-emerald-100 mb-8 max-w-xl">
                We empower healthcare providers with secure, reliable solutions that streamline operations, enhance patient care, and support compliance with healthcare regulations.
              </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-12">
            ...
            <h2 className="text-3xl font-bold text-gray-800 mb-4">
              Navigating Healthcare Industry Complexities
            </h2>
            <p className="text-gray-600">
              The healthcare industry faces unique challenges that demand specialized solutions. At Markov International, we understand these complexities and provide tailored services to effectively address them.
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-12">
            ...
            <h2 className="text-3xl font-bold text-gray-800 mb-4">
              How Markov Empowers Healthcare Institutions
            </h2>
            <p className="text-gray-600">
              Our specialized services address the unique challenges of the healthcare industry, helping you enhance patient care, improve operational efficiency, and ensure compliance with healthcare regulations.
            </p>
          </div>
            ...
            <motion.div variants={fadeInUp}>
              <Card className="h-full hover:shadow-lg transition-shadow">
                <CardHeader>
                  ...
                  <CardTitle>BPO for Healthcare Services</CardTitle>
                ...
                <CardContent>
                  <ul className="space-y-2">
                    <li className="flex items-start">
                      ...
                      <span>Patient support for medical inquiries and issue resolution</span>
                    </li>
                    <li className="flex items-start">
                      <span className="w-2 h-2 rounded-full bg-green-500 mt-2 mr-2"></span>
                      <span>Medical records management and patient scheduling</span>
                    </li>
                    <li className="flex items-start">
                      <span className="w-2 h-2 rounded-full bg-green-500 mt-2 mr-2"></span>
                      <span>Healthcare data entry and document processing</span>
                    </li>
                    <li className="flex items-start">
                      <span className="w-2 h-2 rounded-full bg-green-500 mt-2 mr-2"></span>
                      <span>Claims processing and insurance management</span>
                    </li>
                  </ul>
                </CardContent>
            ...
            <motion.div variants={fadeInUp}>
              <Card className="h-full hover:shadow-lg transition-shadow">
                <CardHeader>
                  ...
                  <CardTitle>IT Solutions for Healthcare</CardTitle>
                  <CardDescription>Secure and compliant healthcare technology infrastructure</CardDescription>
                </CardHeader>
                <CardContent>
                  <ul className="space-y-2">
                    <li className="flex items-start">
                      <span className="w-2 h-2 rounded-full bg-blue-500 mt-2 mr-2"></span>
                      <span>HIPAA-compliant healthcare data management systems</span>
                    </li>
                    <li className="flex items-start">
                      <span className="w-2 h-2 rounded-full bg-blue-500 mt-2 mr-2"></span>
                      <span>Secure electronic health record (EHR) implementation and support</span>
                    </li>
                    <li className="flex items-start">
                      <span className="w-2 h-2 rounded-full bg-blue-500 mt-2 mr-2"></span>
                      <span>Patient data security and encryption solutions</span>
                    </li>
                    <li className="flex items-start">
                      <span className="w-2 h-2 rounded-full bg-blue-500 mt-2 mr-2"></span>
                      <span>Fraud detection and prevention in healthcare claims</span>
                    </li>
                  </ul>
                </CardContent>
            ...
            <motion.div variants={fadeInUp}>
              <Card className="h-full hover:shadow-lg transition-shadow">
                <CardHeader>
                  ...
                  <CardTitle>Digital Marketing for HealthCare</CardTitle>
                ...
                <CardContent>
                  <ul className="space-y-2">
                    <li className="flex items-start">
                      ...
                      <span>Healthcare-specific SEO and content marketing</span>
                    </li>
                    <li className="flex items-start">
                      <span className="w-2 h-2 rounded-full bg-purple-500 mt-2 mr-2"></span>
                      <span>Compliance-aware digital marketing campaigns for healthcare</span>
                    </li>
                    <li className="flex items-start">
                      <span className="w-2 h-2 rounded-full bg-purple-500 mt-2 mr-2"></span>
                      <span>Healthcare education content development</span>
                    </li>
                    <li className="flex items-start">
                      <span className="w-2 h-2 rounded-full bg-purple-500 mt-2 mr-2"></span>
                      <span>Conversion optimization for healthcare services</span>
                    </li>
                  </ul>
                </CardContent>
            ...
            <motion.div variants={fadeInUp}>
              <Card className="h-full hover:shadow-lg transition-shadow">
                <CardHeader>
                  ...
                  <CardTitle>Telecommunications for HealthCare</CardTitle>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-12">
            ...
            <p className="text-gray-600">
            Our solutions meet the highest standards in healthcare compliance, ensuring your patient data remains secure while your operations stay efficient.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 text-center">
              ...
              Our healthcare solutions adhere to all requirements of the Health Insurance Portability and Accountability Act (HIPAA), ensuring patient data privacy and security.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 text-center">
              ...
              <p className="text-gray-600 text-sm">
              Our processes support Know Your Patient (KYP) and Anti-Money Laundering (AML) compliance requirements, ensuring ethical practices and preventing fraud.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 text-center">
              ...
              <p className="text-gray-600 text-sm">
              Advanced encryption ensures all healthcare data, including patient records, is protected both in transit and at rest.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 text-center">
              ...
              <p className="text-gray-600 text-sm">
              Comprehensive audit trails and reporting tools for regulatory compliance (including HIPAA) and transparency in healthcare operations.
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-12">
            ...
            Here's what our healthcare industry clients have to say about their experience working with Markov International.
            </p>
          </div>
          ...
          >
            <motion.div variants={fadeInUp} className="bg-white p-6 rounded-xl shadow-md">
              <div className="flex items-center mb-4">
                ...
                <div>
                  <h4 className="text-lg font-semibold">First Global Hospitalk</h4>
                  <p className="text-sm text-gray-500">Healthcare Services Provider</p>
                </div>
              </div>
              <p className="text-gray-700 italic mb-4">
              Markov International's IT solutions have transformed our healthcare infrastructure. Their security-first approach ensures our patients' data remains protected, while their BPO services have significantly improved our operational efficiency and patient care.              </p>
            ...
            <motion.div variants={fadeInUp} className="bg-white p-6 rounded-xl shadow-md">
              <div className="flex items-center mb-4">
                ...
                <div>
                  <h4 className="text-lg font-semibold">Premier Healthcare Group</h4>
                  <p className="text-sm text-gray-500">Medical Research and Treatment Facility</p>
                </div>
              </div>
              <p className="text-gray-700 italic mb-4">
                "The security solutions provided by Markov have been instrumental in our compliance with healthcare regulations. Their comprehensive approach to data protection gives us and our patients confidence that sensitive medical information is in safe hands."
              </p>
              <div className="flex text-yellow-400">
                {[1, 2, 3, 4, 5].map((star) => (
                  <svg key={star} className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* CTA Section */}
      <section className="py-20 text-white bg-gradient-to-r from-[#0F766E] to-[#0D9488] relative overflow-hidden">
