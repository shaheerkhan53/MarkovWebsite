        ...
        <div className="grid grid-cols-1 gap-12 mb-12 md:grid-cols-2 lg:grid-cols-4">
          <div>
            ...
            <div className="flex space-x-4">
              <Link
                href="https://www.facebook.com/share/1FE6L2hcrc/"
                target="_blank"
              ...
              <Link
                href="https://www.instagram.com/markovinternational?igsh=M3N0czkxOGo4NW5j"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center w-10 h-10 text-gray-400 hover:text-white bg-gray-800 hover:bg-[#2DD8D4] rounded-full transition-colors"
              >
              ...
              <Link
                href="https://www.linkedin.com/company/markov-international-ll/"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center w-10 h-10 text-gray-400 hover:text-white bg-gray-800 hover:bg-[#2DD8D4] rounded-full transition-colors"
              >
